package com.salim.mylocalization
...
import com.salim.mylocalization.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pokeCount = 3
        val hello = resources.getString(R.string.hello_world, "salim maula", pokeCount, "hudzaifah")
